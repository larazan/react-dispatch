    ...
    <>
      <main className="container mx-auto mb-20 px-3">
        ...
        <div></div>
          <div>
            <div className="py-1">
            <span className="text-md md:text-xl font-semibold">Daftar diskusi</span>
            </div>
              ...
              <div className="relative rounded  shadow-md bg-white">
                <div className="flex w-full p-2 md:p-3 items-center justify-between border-b pb-3 bg-gray-200">
                  <div className="flex items-center space-x-3">
                    <Avatar name="bratface" size={"42"} round={true} />
                    ...
                    <div className="p-2 border-l-4 border-blue-400 bg-gray-100 mb-3">
                      <div className="flex flex-col space-y-3">
                        ...
                        <div className="leading-tight">
                          Normally, Drogon would kill anyone who'd seek to harm
                          his "mother", let alone someone who actually killed
                          her. Why didn't he kill Jon?
                        </div>
                      </div>
                    </div>
                    <div className="text-md leading-tight">
                      This is only my opinion, but he didn't kill Jon because he
                      realized that what he did was for the best. That is why he
                      destroyed the 'Iron Throne', he knew that was the cause of
                      her death. Just my opinion. There are thousands of people
                  ...
                  <div className="flex items-center justify-between  text-sm">
                    <div className="flex space-x-4 md:space-x-8">
                      <div className="flex cursor-pointer items-center transition hover:text-[#9cb3c9]">
                        ...
                        <span className="text-xs md:text-sm">balas</span>
                      </div>
                    </div>
                  </div>
                </div>
