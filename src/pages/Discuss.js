      ...
      <div className="py-2 border-b pb-5 md:pb-8 border-gray-200">
        <div className="flex-col pt-4">
          <div className="flex justify-between items-center ">
            <div className="">
              <span className="text-lg font-bold capitalize">review</span>
            </div>
          </div>
          <div className="py-4">
                ...
                <div className="flex mt-4 mb-10 space-x-3 md:space-x-4">
                  <div className="w-2/3">
                    ...
                    <div className="text-sm text-[#9cb3c9]">
                      ...
                      at. Morbi sed gravida nisl, a pharetra nulla. Etiam
                      tincidunt turpis leo, ut mollis ipsum consectetur quis.
                      Etiam faucibus est risus, ac condimentum mauris consequat
                      nec. Curabitur eget feugiat massa
                    </div>
                  </div>
                  <div className="w-1/3">
