...
const MovieDiscussion = () => {
  ...
  const statusses = (status) => {
   ...
   return (
      <span class={` bg-${color}-200 text-${color}-600 py-1 px-3 rounded-full text-xs capitalize`}>{status}</span>
   )
  }
                    ...
                    <table class="min-w-max2 w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light w-full overflow-x-auto">
                          { discussions.map((discuss, id) => (
                            <tr class="border-b border-gray-200 hover:bg-gray-100 w-full"  key={id}>
                                <td class="py-3 px-3 text-left whitespace-nowrap2 w-5/12">
                                    <div class="flex items-center">
                                        <div class="mr-2">
                                          <Avatar name={discuss.name} size={40} round={true} />
                                        </div>
                                ...
                                <td class="py-3 px-6 text-right w-3/12">
                                    <div class="flex flex-col item-center justify-center">
                                        ...
                                        <div>
                                          by
                                          <span className='ml-2 text-blue-300'>raze464</span>
                                        </div>
                                    </div>
                                </td>
                            </tr>
