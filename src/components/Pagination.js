  ...
  return (
    ...
    <div className="flex justify-center my-10 w-full md:w-auto">
          ...
          <div className="flex px-1">
            <button className="border border-[#2affc4] text-[#2affc4] block rounded-full font-bold py-2 px-4  mr-2 flex items-center">
              1
            </button>
            <button className="text-[#2affc4] block font-bold py-2 px-4 mr-2 flex items-center">
              2
            </button>
            <button className="text-[#2affc4] block font-bold py-2 px-4 mr-2 flex items-center">
              3
