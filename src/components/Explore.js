...
function Explore() {
  ...
  return (
    <div className="relative inline-flex ml-3">
      ...
      <Transition
        className="origin-top-right z-40 absolute top-full left-0 -mr-48 sm:mr-0 min-w-80 w-72 bg-[#274059] border border-[#274059] py-1.5 rounded shadow-lg overflow-hidden mt-1"
        show={dropdownOpen}
