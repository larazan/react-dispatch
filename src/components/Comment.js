                    ...
                    <div className="space-y-4 py-4 ml-2">
                      <div className="flex">
                        <div className="flex-shrink-0 mr-0">
                          <img
                            className="mt-2 border rounded-full w-8 h-8 sm:w-10 sm:h-10"
                      ...
                      <div className="flex">
                        ...
                        <div className="flex-1 px-4 py-2 sm:px-4 sm:py-2 leading-relaxed">
                          ...
                          <div className="py-6">
                            <form className="bg-white p-0 w-full ">
                              <textarea
                                name="message"
                        ...
                        <div className="flex-1 px-4 py-2 sm:px-4 sm:py-2 leading-relaxed">
                          ...
                          <div className="space-y-4">
                            <div className="flex">
                              ...
                              <div className="flex-1 bg-white px-4 py-2 sm:px-4 sm:py-2 leading-relaxed">
                                <strong>Sarah</strong>{" "}
