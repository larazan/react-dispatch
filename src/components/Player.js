...
const Player = () => {
  return (
    <>
      <footer className="bg-[#162c41] w-full sticky bottom-0 z-10 col-span-6 p-4 grid grid-cols-3 gap-6 border-t border-gray-800">
        <div className="flex items-center">
          ...
          />
          <div className="mr-4">
            <div className="text-sm text-white text-line-clamp-1 font-semibold leading-tight">
              Re:I AM
            </div>
        ...
        <div>
          <div className="flex items-center justify-center mb-3">
            ...
            <button className="w-7 h-7 text-gray-100 mr-6">
              <svg
            ...
            <button className="w-9 h-9 border border-gray-300 bg-white rounded-full flex text-gray-100 mr-6">
              <svg
