  ...
  return (
    <>
      <footer className="bg-[#1f364d] py-2 px-4 w-full">
        <div className="max-w-10xl mx-auto border-b border-[#9cb3c9]">
          <div className="flex justify-center my-10 w-full md:w-auto">
            <div className="flex flex-col space-y-4">
              <div className="text-center w-full mb-2 justify-center"><img className="w-full h-4" src={logo} alt="liveuamap" /></div>
              <div class="flex justify-around space-x-3 my-4">
